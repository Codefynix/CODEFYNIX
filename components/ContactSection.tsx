  ...
  return (
    <>
      ...
      <section className="sr-only">
        <h2>IT Company in Kochi, Kerala</h2>
        <p>Codefynix is a leading IT solutions company based in Kochi, Kerala, India.
          We specialize in SEO-optimized website development, custom web and mobile application
          development using Next.js,React-native, Node, Express, .Net, MongoDB, PostgreSQL, Tailwind-css,
          AI, Machine learning, CRM solutions, WhatsApp automation, Shopify
          development, e-commerce platforms, and UI/UX design services. Our team
          serves startups and established businesses across Kerala, India and beyond,
          delivering measurable digital growth through modern technology and strategy.</p>
      </section>
    </>
  );
}
